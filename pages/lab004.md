...
Declare the Nitrogen objects you will need. You need to require nitrogen and the nitrogen-file-store, and declare a variable to reference the Nitrogen service and a <code>lightSensor</code> as the Nitrogen device (this is a proxy for the photoresistor circuit you create with the Arduino).
