...
## Bill of Materials
What you will need (all the parts from Lab 2):
...
Congratulations! You have created your first internet connected Thing. Welcome to the world of IoT. In the [next lab](/labs/lab005/) you will create a sample website which you will use to display the data that your Thing is sending into Nitrogen.
