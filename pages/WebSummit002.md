...
categories:
    ...
    - maker-101
author: "Josh Holmes"
permalink: "/websummit/02/"
---
### Table of Contents
*  Auto generated table of contents
{:toc}

In this lab you will write a Node.js application that runs on a hub (your development machine) and collects data from a Particle Photon (over local TCP) and sends it up to an Azure IoT Hub.
...
Using your favorite/preferred text/code editor, create a file in your development directory (c:\Development\IoTLabs) named __package.json__ and add the following:
...
With the package.json file created you can use NPM to pull down the necessary Node modules. Open a Node.js command prompt (Windows) and execute the following commands :
...
In this lab you learned how to write a Node.js/Johnny-Five application that collects environment telemetry and sends it to Azure IoT Hub. 

If your instructor doesn't have the PowerBI reports showing with your device, pleas eask them to pull that up. 
