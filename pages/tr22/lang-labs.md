...
<a class="radius button small" href="../js/">Go to 'Building Connected Things with Node.js' ›</a>
...
<a class="radius button small" href="../cs/">Go to 'Building Connected Things with Windows 10 IoT Core and C#' ›</a>
