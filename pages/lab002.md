...
Congratulations! You have made your first device that responds to its environment, you learned about a voltage divider, how to read data from an input sensor, and how to use the serial monitor. In the [next lab][1] you will put together the two labs so far to make an LED that responds to the ambient light (and you will learn about Pulse-Width Modulation).
