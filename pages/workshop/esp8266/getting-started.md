...
# Install Python, esptool.py

1. Install [Python 2.7](https://www.python.org/downloads/release/python-2711/) for your platform.
2. Once done, install [esptool](https://github.com/themadinventor/esptool/blob/master/README.md) by doing the following:

```pip install esptool```

# Download and Burn the firmware and initialization code to your ESP8266
...
5. Download [initialization code for the ESP8266](esp_init_data_default.bin)
6. Burn the firmware first, using
	
```esptool.py -p /dev/tty.SLAB_USBtoUART write_flash 0x00000 nodemcu-dev-23-modules-2016-04-25-03-53-01-float.bin```

6. Burn the initialization code second, using
