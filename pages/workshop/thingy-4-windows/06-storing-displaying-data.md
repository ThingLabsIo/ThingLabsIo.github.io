...
title: "Lab 06: Storing and Displaying Data"
...
We will use the light data you are sending from [the previous lab](../sending-d2c-messages) and deploy a web application to Azure that will render the data so you can visualize it even if you don't have access to Power BI.

# Using Azure Stream Analytics to Process and Route IoT Data
...
input data stream as the data coming from your IoT Hub. Then you will define an output data stream that sends data to an Event Hub (and optionally to PowerBI). Finally, you 
...
4. Configure the EventHubby doing the following:
...
5. Click the checkmark on the lower-right to create the Event Hub.
...
2. Setup deployment from github:
    ...
    - Click the checkmark on the lower-right to setup your deployment from the ThingLabs Github Repository
    - Click on "Configure" to customize settings for your web app.
        - Turn Web Sockets on.
...
<!-- If you have access to PowerBI you can build a similar real-time reporting dashboard in the [Building a PowerBI Dashboard](../powerbi-dashboard).
...
# Conclusion
In this lab you learned how to create an Azure Stream Analytics job to query data coming in to Azure IoT Hub, process the data, and send it to Event Hub and Power BI.
...
<a class="radius button small" href="{{ site.url }}/workshop/thingy-4-windows/sending-c2d-messages/">Go to 'Lab 07: Sending Cloud-to-Device (C2D) Messages' ›</a>
